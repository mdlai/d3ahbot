...
Func auction()
   ...
   MouseClick("left",187,331,1) ;dex
   MouseMove(243,372)
   MouseDown("left")
   MouseMove(247,454)
   MouseUp("left")
   MouseClick("left",138,468,1)
   ;dex amount
   MouseClick("left",207,332,1)
   Send("150")
   
   MouseClick("left",186,352,1) ;crit chance
   MouseClick("left",144,486,1)
   ;crit amount
   ...
   itemStat()
   $itemnumber = 0
   ;$buyout = random(100,300,1)  ;test buyout
