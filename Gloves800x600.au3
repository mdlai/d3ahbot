...
Func auction()
   ...
   MouseClick("left",212,238,1) ;bracers
   MouseClick("left",123,391,1)
   ...
   MouseClick("left",187,331,1) ;crit chance
   MouseClick("left",139,483,1)
   ;dex amount
   MouseClick("left",207,332,1)
   Send("8")
   
   MouseClick("left",186,352,1) ;crit damage
   MouseClick("left",144,506,1)
   ;crit amount
   ...
   ;itemStat()
   $itemnumber = 0
   $buyout = random(1000000,1200000,1)  ;test buyout
...
Func itemStat()
   If mod($stat,2)=0 then
	  ...
	  MouseUp("left")
	  Send("160")
	  $buyout = random(300000,350000,1)
   ElseIf mod($stat,2)=1 Then
	  MouseClick("left",186,331,1,1)
	  MouseMove(243,504,1)
	  MouseDown("left")
	  MouseMove(240,479,1)
	  MouseUp("left")
	  MouseClick("left",128,393,1,1)
	  ;Delete
	  MouseMove(203,333,1)
	  MouseDown("left")
	  MouseMove(226,332,1)
