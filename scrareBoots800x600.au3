...
Func auction()
   ...
   MouseClick("left",212,236,1) ;boots
   MouseClick("left",133,315,1)
   ...
   MouseClick("left",186,330,1) ;dex
   MouseMove(209,372)
   MouseDown("left")
   MouseMove(211,450)
   MouseUp("left")
   MouseClick("left",124,458,1)
   ;dex amount
   MouseClick("left",207,332,1)
   Send("220")
   
   MouseClick("left",187,354,1) ;movespeed
   MouseMove(209,395)
   MouseDown("left")
   MouseMove(205,540)
   MouseUp("left")
   MouseClick("left",133,504,1)
   ;crit amount
